        ...
        <div className="flex flex-col z-20 bg-gradient-to-br from-sky-300/20 via-neutral-600/20 to-purple-600/20 ring-1 ring-white/40 hover:scale-105 cursor-pointer duration-300 transition-all backdrop-blur-sm rounded-md w-full">
            <div className="px-6 py-8 sm:p-10 sm:pb-6">
                <div className="grid items-center justify-center w-full grid-cols-1 text-left">
                    <div>
                        <h2 className="text-lg font-bold tracking-tighter text-black/ lg:text-2xl" > {planName} </h2>
                        <p className="mt-2 font-semibold text-gray-400 h-12"> {planDiscription} </p>
                    </div>
                    <div className="mt-16">
                        <p>
                            <span className="text-5xl font-bold tracking-tight bg-gradient-to-br bg-clip-text text-transparent from-indigo-500 to-sky-400"> {planPrice} </span>
                            <span className="text-sm text-gray-400"> {planDuration} </span>
                        </p>
                    </div>
                </div>
            </div>
            <div className="flex px-6 pb-8 sm:px-8">
                <PrimaryButton label={buttonLabel} customClass="w-full" />
            </div>
        </div>
