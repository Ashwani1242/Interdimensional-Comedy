...
function PricingSection() {
  return (
    <div className="w-full h-fit px-96 py-32 flex justify-center items-center">
      <div className="group relative">
        ...
        <div className="w-full ring-1 ring-white/20 h-full rounded-3xl relative overflow-hidden max-h-[600px] max-w-[1200px]">
          <InteractiveDisplay />
          <div className="p-20 flex flex-col items-center justify-center">
            <div className="text-4xl font-semibold relative z-20 w-full h-20 mb-16">
